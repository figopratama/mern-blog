...
export function About() {
    return (
        <div className="w-1/3">
            ...
            <p className="leading-7 [&:not(:first-child)]:mt-6 whitespace-pre-wrap text-center">Our platform provides a space for users to share their thoughts, experience, and expertise throughblog posts.</p>
            <p className="leading-7 [&:not(:first-child)]:mt-6 whitespace-pre-wrap text-center">If youre interested in contributing , feel free to create a new blog by visiting our <Link to="/createBlog">Create Blog</Link> page.</p>
